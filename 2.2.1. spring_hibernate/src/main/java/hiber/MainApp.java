...
public class MainApp {
   public static void main(String[] args) {
      ...
      // Пример использования метода getUserByCarModelAndSeries()
      User user = userService.getUserByCarModelAndSeries("Model3", 3);
      if (user != null) {
         System.out.println("User found with Car Model 'Model3' and Series '3': " + user.getFirstName());
      } else {
         System.out.println("No user found with Car Model 'Model3' and Series '3'.");
      }
